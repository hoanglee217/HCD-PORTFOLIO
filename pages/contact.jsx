                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Da Nang</span>
                            </div>
                            {/* <div className="flex justify-between items-center">
                        ...
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'><a href='mailto:hoangxam2@gmail.com'>hoangxam2@gmail.com</a></span>
                            </div>
                            {/* <div className="flex justify-between items-center">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'><a href='tel:0901968477'>+84 901 968 477</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    <a className='hover:scale-125 ease-in-out duration-700' href="mailto:hoangxam2@gmail.com" target='_blank' rel="noreferrer"><HiMail /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/hoanglee217" target='_blank' rel="noreferrer"><FaGithub /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://www.facebook.com/hoanglee217/" target='_blank' rel="noreferrer"><FaFacebook /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="skype:live:hoangxam2?chat" target='_blank' rel="noreferrer"><BsSkype /></a>
